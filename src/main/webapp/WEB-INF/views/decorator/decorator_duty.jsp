...
<div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">信通院排班系统 V1.01</a>
            </div>
            <!-- /.navbar-header -->
    	...
    	<!-- jQuery -->
	<script
		src="/security//resources/bower_components/jquery/dist/jquery.min.js"></script>

	<!-- Bootstrap Core JavaScript -->
	<script
		src="/security//resources/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

	<!-- Metis Menu Plugin JavaScript -->
	<script
		src="/security//resources/bower_components/metisMenu/dist/metisMenu.min.js"></script>
